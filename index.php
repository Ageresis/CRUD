...
$koneksi = mysqli_connect($host, $user, $pass, $data_base);
...
if (isset($_POST['simpan'])) { //untuk crate
    ...
    if ($nim && $nama && $alamat && $fakultas) {
        if($op == 'edit') {//intuk update
            $sql1 = "update mahasiswa set nim = '$nim',nama='$nama',alamat = '$alamat',fakultas='$fakultas' where id = '$id'";
            $q1 = mysqli_query($koneksi,$sql1);
            if($q1){
                $sukses ="Data berhasil di update";  
            }else{
                $error = "Daata gagal di update";
            }
        }else{ //intuk insert
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="Post">
                    ...
                    <div class="mb-3 row">
                        <label for="fakiltas" class="col-sm-2 col-form-label">Fakultas</label>
                        <div class="col-sm-10">
                            <select for="fakultas" class="form-control" name="fakultas" id="fakultas">
